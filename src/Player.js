    ...
    if (channelData && channelData.currentVideo) {
      ...
      setTimeout(() => {
        this.setState({
          videoId,
          playerOpts: {
            playerVars: { ...defaultPlayerVars, start: videoStart, end: videoEnd },
          },
        });
      }, VIDEO_TRANSITION_MS);
    }
  ...
  render() {
    ...
    return (
      <div className="overflow-hidden">
        <div
          className={`video-background overflow-hidden transition-opacity duration-1000 ${
        ...
        >
          ...
          {videoId && (
            <div
              className={`video-foreground transition-opacity ease-in-out duration-${VIDEO_TRANSITION_MS} ${
